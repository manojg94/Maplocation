...
public class BackgroundLocationUpdateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, Callback<uploadData> {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                uploadData("RealtimeTest",latitude+","+longitude,"6438785386573");


            }
        }, 6000, delay);//put here time 1000 milliseconds=1 second
        buildGoogleApiClient();

        return START_STICKY;
    }

    private void uploadData(String name, String latlng, String time) {
